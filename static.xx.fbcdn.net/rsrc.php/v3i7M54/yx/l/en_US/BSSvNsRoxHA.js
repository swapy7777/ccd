...
__d("Bootloader", ["invariant", "BootloaderConfig", "BootloaderEndpoint", "BootloaderEvents", "BootloaderEventsManager", "BootloaderRetryTracker", "CSRBitMap", "CSRIndexUtil", "CSSLoader", "CSSLoaderConfig", "ClientConsistency", "ErrorPubSub", "ExecutionEnvironment", "FBLogger", "JSResourceReferenceImpl", "MakeHasteTranslations", "NetworkStatus", "RequireDeferredReference", "ResourceHasher", "ResourceTimingsStore", "SiteData", "TimeSlice", "TrustedTypesBootloaderDataURIScriptURLPolicy", "TrustedTypesMetaURIScriptURLPolicy", "__debug", "clearTimeout", "cr:696703", "err", "fb-error", "ifRequireable", "ifRequired", "nullthrows", "performanceAbsoluteNow", "performanceNow", "promiseDone", "setTimeoutAcrossTransitions"], (function(a, b, c, d, e, f, g, h) {
    ...
    function ia(a, b, d, f) {
        ...
        T((j == null ? void 0 : j.r) || [], {
            ...
            onAll: function() {
                return F.registerCallback(function() {
                    F.notify(F.tierThreeStart(a)), e.call(null, m.map(c("RequireDeferredReference").getRDModuleName_DO_NOT_USE), function() {
...
__d("PluginLoginButton", ["Arbiter", "DOMEvent", "DOMQuery", "FBLogger", "PlatformOAuthDialogLoginFunnelLogger", "PlatformWidgetEndpoint", "Plugin", "PluginDOMEventListener", "PluginLoginButtonEventsTypedLogger", "PluginReturn", "URI", "UnverifiedXD", "XOAuthErrorController", "buildPopupFeatureString", "isFacebookURI", "sdk.UA"], (function(a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
        d("PluginDOMEventListener").add(a, "click", l.bind(null, b))
    }
    ...
    function e(a, b, e, f, g, h, i, j, k, l, m, o, p, q, r, s, t, u, v) {
        f = function(a, b) {
            if (l) {
        ...
        n(a, function(a) {
            ...
            c("Arbiter").subscribe("Connect.Unsafe.loginComplete", function() {
                new(c("PluginLoginButtonEventsTypedLogger"))().setEvent("login_complete").setAppID(b).setLoggerID(m).setIsLegacy(o).setLayout(p).setUseContinueAs(t).setIsContinueAsToggled(u).logVital(), d("PlatformOAuthDialogLoginFunnelLogger").log("client_login_end", null, m, !1)
            });
            c("UnverifiedXD").send({
                type: "login_button_dialog_open",
                params: JSON.stringify(a)
            });
            new(c("PluginLoginButtonEventsTypedLogger"))().setEvent("click").setAppID(b).setLoggerID(m).setIsLegacy(o).setLayout(p).setUseContinueAs(t).setIsContinueAsToggled(u).logVital();
            d("PlatformOAuthDialogLoginFunnelLogger").log("client_login_start", null, m, !1)
        })
    }

    function f(a, b, e, f, g, l, m, o, p, q, r, s, t, u, v, w, x, y, z) {
        f = function(a, b) {
            if (q) {
                a = d("PlatformWidgetEndpoint").plugins("login_button");
                d("PluginReturn").reload(a + (b.crossFrame ? "" : "?ret=perms"))
        ...
        var A = {
            ...
            logger_id: r,
            version: g,
            force_confirmation: u,
            messenger_page_id: v,
            reset_messenger_state: w,
            config_id: z
        };
        c("Arbiter").subscribe("Connect.Unsafe.loginButtonStateInit", function(a, b) {
            ...
            if (k != null) {
                ...
                var d = !1;
                try {
                    d = c("isFacebookURI")(new(h || (h = c("URI")))(b.call.url)), d || a()
                } catch (b) {
                    a()
                }
                d || (k.url = c("XOAuthErrorController").getURIBuilder().setEnum("error_code", "PLATFORM__INVALID_URL").getURI().toString())
            }
        });
        c("UnverifiedXD").send({
        ...
        c("Arbiter").subscribe("Connect.Unsafe.loginComplete", function(a, e) {
            i[e.frame_name] != null && typeof i[e.frame_name].close === "function" && (i[e.frame_name].close(), delete i[e.frame_name]), e.status === "connected" ? k = null : c("UnverifiedXD").send({
                type: "login_button_prepare_call",
                params: JSON.stringify(A)
            }), new(c("PluginLoginButtonEventsTypedLogger"))().setEvent("login_complete").setAppID(b).setLoggerID(r).setIsLegacy(s).setLayout(t).setUseContinueAs(x).setIsContinueAsToggled(y).logVital(), d("PlatformOAuthDialogLoginFunnelLogger").log("client_login_end", null, r, !1)
        });
        n(a, function(a) {
            new(c("DOMEvent"))(a).kill();
            if (k == null) c("UnverifiedXD").send({
                type: "login_button_connected",
                params: "{}"
            });
            else if (i[k.id] != null && !i[k.id].closed) i[k.id].focus();
            else {
                a = Date.now();
                k.url = k.url.replace(/cbt=\d+/, "cbt=" + a);
                a = window.open(k.url, k.id, c("buildPopupFeatureString")(k));
                c("UnverifiedXD").send({
                ...
                if (a != null) {
                    ...
                    j = window.setInterval(function() {
                        i[e] != null && i[e].closed && (c("UnverifiedXD").send({
                            type: "login_button_popup_closed",
                            params: "{}"
                        }), delete i[e], window.clearInterval(j))
                    }, 100)
                }
                new(c("PluginLoginButtonEventsTypedLogger"))().setEvent("click").setAppID(b).setLoggerID(r).setIsLegacy(s).setLayout(t).setUseContinueAs(x).setIsContinueAsToggled(y).logVital();
                d("PlatformOAuthDialogLoginFunnelLogger").log("client_login_start", null, r, !1)
            }
        })
    }
...
__d("FalcoLoggerTransports", ["AnalyticsCoreData", "Banzai", "ExecutionEnvironment", "FBLogger", "FalcoAppUniverse", "FalcoUtils", "ODS", "PersistedQueue", "Queue", "WebSession", "performanceAbsoluteNow", "promiseDone", "requireDeferredForDisplay", "uuidv4"], (function(a, b, c, d, e, f, g) {
    ...
    function Q(a, b) {
        for (var e = 0; e < a.length; e++) {
            ...
            if (g.exptTags) {
                ...
                h.length === 3 && (h[2] === "on" ? f.c = "falco_js_br_stateful_migration:on" : h[2] === "off" && (f.c = "falco_js_br_stateful_migration:off"))
            }
    ...
    function Z(a) {
        ...
        if (((b = (i || (i = c("AnalyticsCoreData"))).br_stateful_migration_exp) != null ? b : !1) && a.policy.s !== 1) {
            if ((b = (i || (i = c("AnalyticsCoreData"))).br_stateful_migration_on) != null ? b : !1) {
